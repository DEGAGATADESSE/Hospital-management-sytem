...
<table width="71%" border="1">
  <tr>
    ...
    <th colspan="2" width="13%" scope="col">Action</th>   
  </tr>
  <?php
	  ...
	  while($x=mysqli_fetch_assoc($runq))
	  {
		  ...
		  <td>".$x['firstname']."</td>
		    <td>".$x['lastname']."</td>
			 ...
			 <td>".$x['phonenumber']."</td>
			  <td>".$x['password']."</td>
			  <td><a href='delete_patient.php?id=".$x['id']."'>delete</a></td>
			  <td><a href='update_patient.php?id=".$x['id']."'>Edit</a></td>
		  </tr>
  ...
  ?>
  <tr>  <td ><a href='register_patients.html'>Add user</a></td>
</tr>
</table>
</body>
</html>