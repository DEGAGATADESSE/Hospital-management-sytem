...
{
	$pn=$_GET['phonenumber'];
	$sqr="select *from doctor where phonenumber='$pn'";
...
if(isset($_POST['update']))
{
	...
	$pn=$_POST['pnumber'];
	$p=$_POST['pword'];
	$upq="update doctor set firstname='$f',lastname='$l',username='$u',email='$e',password='$p' where phonenumber='$pn'";
...
<p>&nbsp;</p>
<div id="div1">
  <form id="form1" name="form1" method="post" action="update_doctor.php">
    <blockquote>
      <blockquote>
        <p>REGISTER NOW
        </p>
    ...
    <p>
      ...
      <input type="text" name="uname" id="un" placeholder="enter user name" value="<?php echo $u; ?>"/>
</p>
    <p>
    ...
    <p><label for="gender">&nbsp;&nbsp;&nbsp;&nbsp;Gender</label></p>
      <p>
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="checkbox" id="checkbox" value="female" />
      ...
      <p>
        ...
        <input type="text" name="pnumber" id="pn" placeholder="enter phone number" value="<?php echo $pn; ?>" readonly="readonly" />
      </p>
      <p>
        <label for="pword">&nbsp;&nbsp;&nbsp;&nbsp;Password</label>
        <input type="password" name="pword" id="ps" placeholder="enter password" value="<?php echo $p; ?>"/>
      </p>
   
        &nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="update" id="update" onclick="return formvalidate();" value="update" />
        <p> &nbsp;&nbsp;&nbsp;&nbsp;I already have an account <a href="login_doctor.php"><strong>&nbsp;&nbsp;LOGIN</strong></a></p>
  </form>
</div>
<blockquote>
  <blockquote>
