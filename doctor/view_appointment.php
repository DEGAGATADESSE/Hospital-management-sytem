...
<body>
<a href="../admin/admin_dashboard.php">Back</a><br />
...
<table width="96%" border="1">
  <tr>
   <th width="4%" scope="col">ID</th>
    ...
    <th width="6%" scope="col">Gender</th>
    <th width="11%" scope="col">Phone Number</th>
    <th width="4%" scope="col">age</th>
     <th width="4%" scope="col">weight</th>
      <th width="28%" scope="col">Symptom</th>
      <th colspan="2" width="11%" scope="col">action</th>
